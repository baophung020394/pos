...
interface InputFieldsPolicyProps {
    name: keyof FormData;
    label?: string;
    placeholder?: string;
...
const InputFieldsPolicy: React.FC<InputFieldsPolicyProps> = ({ name, className, label, control, type = 'text', startIcon, endIcon, placeholder }) => {
...
export default InputFieldsPolicy;
